      ...
      <body>
        ...
        <div class="container">
          ...
          <div class="login-box">
            ...
            <div>
              <form action="/sriracha/login.do" method="post" id="loginForm" name="loginForm">
                <input class="inputBox login-id" type="text" name="user_id" id="user_id" placeholder="아이디를 입력하세요." />
                <p class="error-message-empty-id" id="login-id-text">정확한 이메일
                  주소나 전화번호를 입력하세요.</p>
                <input class="inputBox login-pw" type="password" name="user_pw" id="user_pw" placeholder="비밀번호를 입력하세요."
                  onkeyup="enterKey()" />
                <p class="error-message-empty-pw" id="login-pw-text">비밀번호는
                  4~60자 사이여야 합니다.</p>
                <input type="button" class="login-button" value="로그인" onclick="checkLogin()" />
                <div class="form-bottom">
                  <div class="login-remember">
                    <input type="checkbox" id="saveId" name="saveId" /> <label for="saveId">아이디 정보 저장</label>
                  </div>
              </form>
