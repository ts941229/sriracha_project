                                    ...
                                    <div class="chart_cont1 swiper-wrapper">
                                        ...
                                        <c:forEach var="nowPlayingMovie" items="${nowPlayingMovieList }"
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="infor">
                                                    <div class="infor_btn">
                                                        <span class="type1-content_title">${nowPlayingMovie.movie_title
                                                            }</span>
                                                        <span class="type1-content_year">${nowPlayingMovie.movie_date
                                                            }</span>
                                                        <span class="type1-content_star">평균★
                                                            ${nowPlayingMovie.movie_vote_average/2 }</span>
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="infor">
                                                    <div class="infor_btn">
                                                        ...
                                                        <span class="type1-content_star">평균★
                                                            ${popularMovie.movie_vote_average/2 }</span>
                                                        <span class="type1-content_info">인기 점수 :
                                    ...
                                    <div class="chart_cont1 swiper-wrapper">
                                        ...
                                        <c:forEach var="topRatedMovie" items="${topRatedMovieList }" varStatus="status">
                                            <div class="swiper-slide">
                                                ...
                                                <div class="infor">
                                                    <div class="infor_btn">
                                                        <span class="type1-content_title">${topRatedMovie.movie_title
                                                            }</span>
                                                        <span class="type1-content_year">${topRatedMovie.movie_date
                                                            }</span>
                                                        <span class="type1-content_star">평균★
                                                            ${topRatedMovie.movie_vote_average/2 }</span>
                                                        <span class="type1-content_info">인기 점수 :
                                    ...
                                    <div class="chart_cont1 swiper-wrapper">
                                        ...
                                        <c:forEach var="upComingMovie" items="${upComingMovieList }" varStatus="status">
                                            <div class="swiper-slide">
                                                ...
                                                <div class="infor">
                                                    <div class="infor_btn">
                                                        <span class="type1-content_title">${upComingMovie.movie_title
                                                            }</span>
                                                        <span class="type1-content_year">${upComingMovie.movie_date
                                                            }</span>
                                                        <span class="type1-content_star">평균★
                                                            ${upComingMovie.movie_vote_average/2 }</span>
                                                        <span class="type1-content_info">인기 점수 :
